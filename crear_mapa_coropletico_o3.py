...
del contaminante O3 (Ozono) por estado en México.
"""
...
def main():
    ...
    print("--- Iniciando script de mapa coroplético para O3 ---")
    ...
    # --- CAMBIO PRINCIPAL: Se especifica el nuevo contaminante ---
    contaminante_a_analizar = 'o3'

    # --- 2. Cargar y Preparar Datos ---
    try:
        print(f"Cargando y preparando datos de contaminación para {contaminante_a_analizar.upper()}...")
        ...
        print(f"Calculando promedios de {contaminante_a_analizar.upper()} por estado...")
    ...
    mapa_final_gdf.plot(
        ...
        cmap='plasma', # Cambiamos la paleta de colores para diferenciarlo del otro mapa
        linewidth=0.8,
        ax=ax,
        edgecolor='0.8',
        legend=True,
        ...
        legend_kwds={
            'label': f"Promedio de {contaminante_a_analizar.upper()} (ppb)",
